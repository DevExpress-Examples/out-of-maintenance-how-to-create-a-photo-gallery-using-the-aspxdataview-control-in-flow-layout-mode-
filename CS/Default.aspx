...
<%@ Register Assembly="DevExpress.Xpo.v13.1, Version=13.1.14.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Xpo" TagPrefix="dx" %>
                                    ...
                                    <tr>
                                        <td onclick="ShowImage(<%# Eval("id") %>)"
                                            ...
                                            <dxe:ASPxImage ID="imgPhoto" ImageUrl='<%# GetThumbnailImageUrl(Eval("ThumbnailFileName").ToString()) %>'
                                                AlternateText='<%# Eval("Title") %>' Height='<%# int.Parse(Eval("ThumbnailHeight").ToString()) %>'
                                                Width='<%# int.Parse(Eval("ThumbnailWidth").ToString()) %>' runat="server" /></td>
                                    </tr>
                                </table>
